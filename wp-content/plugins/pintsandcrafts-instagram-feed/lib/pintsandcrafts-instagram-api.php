...
include 'pintsandcrafts-instagram-helper.php';

/**
 * Class PintsAndCraftsInstagramApi
 */
class PintsAndCraftsInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var PintsAndCraftsInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var PintsAndCraftsInstagramHelper
     */
    private $helper;

    const CODE_OPTION_NAME = 'pintsandcrafts_instagram_code';
    const USER_ID_OPTION_NAME = 'pintsandcrafts_instagram_user_id';
    const ACCESS_TOKEN_OPTION_NAME = 'pintsandcrafts_instagram_access_token';
    const CODE_REDIRECT_URI_OPTION_NAME = 'pintsandcrafts_instagram_code_redirect_uri';
    ...
    private function __construct() {
        ...
        $this->helper = new PintsAndCraftsInstagramHelper();
    }
    ...
    /**
     * @return PintsAndCraftsInstagramApi
     */
     ...
     * @return string
     *
     * @see PintsAndCraftsInstagramApi::buildCurrentPageURI()
     */
    ...
    /**
     * @return PintsAndCraftsInstagramHelper
     */
     ...
     *
     * @see PintsAndCraftsInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see PintsAndCraftsInstagramApi::getAccessToken()
     */
