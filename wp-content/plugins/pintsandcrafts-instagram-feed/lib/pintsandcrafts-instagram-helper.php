...
/**
 * Class PintsAndCraftsInstagramHelper
 */
class PintsAndCraftsInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines pintsandcrafts_instagram_image_atts filter
    ...
    public function getImageHTML($image, $imageSize) {
        ...
        $imageAtts = apply_filters('pintsandcrafts_instagram_image_atts',
            array(
                'class' => $imageSize,
