<?php
if ( ! function_exists( 'pintsandcrafts_edge_init_google_fonts_array' ) ) {
    function pintsandcrafts_edge_init_google_fonts_array() {
        ...
        $pintsandcrafts_php_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'pintsandcrafts_edge_init_google_fonts_array');
}