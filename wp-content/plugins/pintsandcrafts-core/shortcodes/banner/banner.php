<?php
namespace PintsAndCraftsCore\CPT\Shortcodes\Banner;
...
class Banner implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Banner', 'pintsandcrafts-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'skin',
							'heading'     => esc_html__( 'Skin Color', 'pintsandcrafts-core' ),
							'value'       => array(
								esc_html__( 'Default - Light', 'pintsandcrafts-core' )  => '',
								esc_html__( 'Dark', 'pintsandcrafts-core' )             => 'pintsandcrafts-dark-skin'
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Overlay Color', 'pintsandcrafts-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hover_behavior',
							'heading'     => esc_html__( 'Hover Behavior', 'pintsandcrafts-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'pintsandcrafts-core' )   => 'edgtf-visible-on-hover',
								esc_html__( 'Visible on Default', 'pintsandcrafts-core' ) => 'edgtf-visible-on-default',
								esc_html__( 'Disabled', 'pintsandcrafts-core' )           => 'edgtf-disabled'
							),
							'save_always' => true
						),
                        array(
                            ...
                            'heading'     => esc_html__( 'Border Skin', 'pintsandcrafts-core' ),
                            'value'       => array(
                                esc_html__( 'Default', 'pintsandcrafts-core' )  => 'default',
                                esc_html__( 'Yellow', 'pintsandcrafts-core' )   => 'yellow'
                            ),
                            'save_always' => true,
                            'dependency' => array( 'element' => 'hover_behavior', 'value' => array( 'edgtf-visible-on-hover', 'edgtf-visible-on-default' ) )
                        ),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'info_position',
							'heading'     => esc_html__( 'Info Position', 'pintsandcrafts-core' ),
							'value'       => array(
								esc_html__( 'Default', 'pintsandcrafts-core' )  => 'default',
								esc_html__( 'Centered', 'pintsandcrafts-core' ) => 'centered'
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'     => esc_html__( 'Subtitle Tag', 'pintsandcrafts-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Subtitle Color', 'pintsandcrafts-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Light Font Weight', 'pintsandcrafts-core' ),
							'description' => esc_html__( 'Enter the positions of the words you would like to display in a "light" font weight. Separate the positions with commas (e.g. if you would like the first, third, and fourth word to have a light font weight, you would enter "1,3,4")', 'pintsandcrafts-core' ),
							'dependency'  => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'    => esc_html__( 'Link Text', 'pintsandcrafts-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'link_color',
							'heading'    => esc_html__( 'Link Text Color', 'pintsandcrafts-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = pintsandcrafts_core_get_shortcode_module_template_part( 'templates/banner', 'banner', '', $params );
	...
	private function getHolderClasses( $params, $args ) {
		...
		$holderClasses[] = ! empty( $params['skin'] ) ? esc_attr( $params['skin'] ) : '';
        $holderClasses[] = ! empty( $params['border_skin'] ) ? 'edgtf-banner-border-' . $params['border_skin'] : 'edgtf-banner-border-' . $args['border_skin'];

        if ( ! empty( $params['link'] ) ) {
            $holderClasses[] = 'edgtf-has-link';
        }
