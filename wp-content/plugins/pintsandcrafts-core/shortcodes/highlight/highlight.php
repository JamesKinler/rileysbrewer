<?php
namespace PintsAndCraftsCore\CPT\Shortcodes\Highlight;
...
class Highlight implements Lib\ShortcodeInterface {
	...
	public function render( $atts, $content = null ) {
		...
		$html = pintsandcrafts_core_get_shortcode_module_template_part( 'templates/highlight-template', 'highlight', '', $params );
