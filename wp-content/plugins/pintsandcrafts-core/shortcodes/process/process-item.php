...
class ProcessItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Process Item', 'pintsandcrafts-core' ),
					'base'     => $this->base,
	...
	public function render( $atts, $content = null ) {
		...
		$html = pintsandcrafts_core_get_shortcode_module_template_part( 'templates/process-item-template', 'process', '', $params );
