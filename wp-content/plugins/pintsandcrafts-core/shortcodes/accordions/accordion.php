<?php
namespace PintsAndCraftsCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'pintsandcrafts-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'pintsandcrafts-core' ) => 'accordion',
								esc_html__( 'Toggle', 'pintsandcrafts-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
							...
							'value'      => array(
								esc_html__( 'Boxed', 'pintsandcrafts-core' )  => 'boxed',
						...
						array(
							...
							'heading'    => esc_html__( 'Background Skin', 'pintsandcrafts-core' ),
							'value'      => array(
								esc_html__( 'Default', 'pintsandcrafts-core' ) => '',
								esc_html__( 'White', 'pintsandcrafts-core' )   => 'white'
							),
	...
	public function render( $atts, $content = null ) {
		...
		$output = pintsandcrafts_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );
