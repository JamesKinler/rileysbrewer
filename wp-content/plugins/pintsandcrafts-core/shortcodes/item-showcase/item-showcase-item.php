<?php
namespace PintsAndCraftsCore\CPT\Shortcodes\ItemShowcase;
...
class ItemShowcaseItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Item Showcase List Item', 'pintsandcrafts-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							...
							'heading'     => esc_html__( 'Item Position', 'pintsandcrafts-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Item Title', 'pintsandcrafts-core' ),
							'admin_label' => true
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Item Target', 'pintsandcrafts-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Item Title Tag', 'pintsandcrafts-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Item Title Color', 'pintsandcrafts-core' ),
							'dependency' => array( 'element' => 'item_title', 'not_empty' => true )
						),
						array(
							'type'       => 'textarea',
							'param_name' => 'item_text',
							'heading'    => esc_html__( 'Item Text', 'pintsandcrafts-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'item_text_tag',
							'heading'     => esc_html__( 'Item Text Tag', 'pintsandcrafts-core' ),
							'value'       => array_flip( pintsandcrafts_edge_get_title_tag( true ) ),
							'save_always' => true,
						...
						array(
							...
							'heading'    => esc_html__( 'Item Text Color', 'pintsandcrafts-core' ),
							'dependency' => array( 'element' => 'item_text', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$params['item_text_tag']       = ! empty( $params['item_text_tag'] ) ? $params['item_text_tag'] : $args['item_text_tag'];
		$params['item_text_styles']    = $this->getTextStyles( $params );
		
		$html = pintsandcrafts_core_get_shortcode_module_template_part( 'templates/item-showcase-item', 'item-showcase', '', $params );
