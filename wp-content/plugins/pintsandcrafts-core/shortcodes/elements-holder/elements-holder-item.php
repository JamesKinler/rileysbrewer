...
class ElementsHolderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Elements Holder Item', 'pintsandcrafts-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'pintsandcrafts-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'horizontal_alignment',
							'heading'    => esc_html__( 'Horizontal Alignment', 'pintsandcrafts-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Vertical Alignment', 'pintsandcrafts-core' ),
							'value'      => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Default (No Animation)', 'pintsandcrafts-core' )   => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 1280px-1600px', 'pintsandcrafts-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'pintsandcrafts-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'pintsandcrafts-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'item_padding_1024_1280',
							'heading'     => esc_html__( 'Padding on screen size between 1024px-1280px', 'pintsandcrafts-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'pintsandcrafts-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'pintsandcrafts-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 768px-1024px', 'pintsandcrafts-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'pintsandcrafts-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'pintsandcrafts-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 680px-768px', 'pintsandcrafts-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'pintsandcrafts-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'pintsandcrafts-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size bellow 680px', 'pintsandcrafts-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'pintsandcrafts-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'pintsandcrafts-core' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = pintsandcrafts_core_get_shortcode_module_template_part( 'templates/elements-holder-item-template', 'elements-holder', '', $params );
