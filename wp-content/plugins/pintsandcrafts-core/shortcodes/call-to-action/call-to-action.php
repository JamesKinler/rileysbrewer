<?php
namespace PintsAndCraftsCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'pintsandcrafts-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'layout',
							'heading'     => esc_html__( 'Layout', 'pintsandcrafts-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'pintsandcrafts-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'pintsandcrafts-core' ),
							'value'      => array(
								esc_html__( '80/20', 'pintsandcrafts-core' ) => '80',
								esc_html__( '75/25', 'pintsandcrafts-core' ) => '75',
								esc_html__( '66/33', 'pintsandcrafts-core' ) => '66',
								esc_html__( '50/50', 'pintsandcrafts-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px)', 'pintsandcrafts-core' ),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'simple' ) ),
							'group'      => esc_html__( 'Button Style', 'pintsandcrafts-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'pintsandcrafts-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link Target', 'pintsandcrafts-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'pintsandcrafts-core' ),
							'group'      => esc_html__( 'Button Style', 'pintsandcrafts-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_color',
							'heading'    => esc_html__( 'Button Hover Color', 'pintsandcrafts-core' ),
							'group'      => esc_html__( 'Button Style', 'pintsandcrafts-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_background_color',
							'heading'    => esc_html__( 'Button Background Color', 'pintsandcrafts-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'pintsandcrafts-core' ),
							'group'      => esc_html__( 'Button Style', 'pintsandcrafts-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'pintsandcrafts-core' ),
							'group'      => esc_html__( 'Button Style', 'pintsandcrafts-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'pintsandcrafts-core' ),
							'group'      => esc_html__( 'Button Style', 'pintsandcrafts-core' )
						),
						array(
							'type'       => 'textarea_html',
							...
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'pintsandcrafts-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = pintsandcrafts_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . pintsandcrafts_edge_filter_px( $params['button_top_margin'] ) . 'px';
		}
