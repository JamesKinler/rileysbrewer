...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'pintsandcrafts-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Type', 'pintsandcrafts-core' ),
							'value'       => array(
								esc_html__( 'Title', 'pintsandcrafts-core' )          => 'title',
								esc_html__( 'Category', 'pintsandcrafts-core' )       => 'category',
								esc_html__( 'Tag', 'pintsandcrafts-core' )            => 'tag',
								esc_html__( 'Author', 'pintsandcrafts-core' )         => 'author',
								esc_html__( 'Date', 'pintsandcrafts-core' )           => 'date',
								esc_html__( 'Featured Image', 'pintsandcrafts-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Label', 'pintsandcrafts-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'pintsandcrafts-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'pintsandcrafts-core' ),
							'value'      => array_flip( pintsandcrafts_edge_get_title_tag( true, array( 'p' => 'p' ) ) ),
