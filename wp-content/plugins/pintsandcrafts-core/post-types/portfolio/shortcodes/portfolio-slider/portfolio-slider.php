...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Slider', 'pintsandcrafts-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Items', 'pintsandcrafts-core' ),
							'admin_label' => true,
							'description' => esc_html__( 'Set number of items for your portfolio slider. Enter -1 to show all', 'pintsandcrafts-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Number of portfolios that are showing at the same time in slider (on smaller screens is responsive so there will be less items shown). Default value is Four', 'pintsandcrafts-core' ),
							'save_always' => true,
							'admin_label' => true
						),
						array(
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio slider.', 'pintsandcrafts-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
						...
						array(
							...
							'heading'    => esc_html__( 'Navigation Skin', 'pintsandcrafts-core' ),
							'value'      => array(
								esc_html__( 'Default', 'pintsandcrafts-core' ) => '',
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Skin', 'pintsandcrafts-core' ),
							'value'      => array(
								esc_html__( 'Default', 'pintsandcrafts-core' ) => '',
								esc_html__( 'Light', 'pintsandcrafts-core' )   => 'light',
								esc_html__( 'Dark', 'pintsandcrafts-core' )    => 'dark'
						...
						array(
							...
							'heading'     => esc_html__( 'Pagination Position', 'pintsandcrafts-core' ),
							'value'       => array(
								esc_html__( 'Below Slider', 'pintsandcrafts-core' ) => 'below-slider',
								esc_html__( 'On Slider', 'pintsandcrafts-core' )    => 'on-slider'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'enable_pagination', 'value' => array( 'yes' ) ),
							'group'       => esc_html__( 'Slider Settings', 'pintsandcrafts-core' )
