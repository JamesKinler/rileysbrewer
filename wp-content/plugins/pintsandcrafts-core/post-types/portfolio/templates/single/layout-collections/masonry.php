<?php
$masonry_classes = '';
$number_of_columns = pintsandcrafts_edge_get_meta_field_intersect('portfolio_single_masonry_columns_number');
if(!empty($number_of_columns)) {
	$masonry_classes .= ' edgtf-ps-'.$number_of_columns.'-columns';
}
$space_between_items = pintsandcrafts_edge_get_meta_field_intersect('portfolio_single_masonry_space_between_items');
