...
namespace PintsAndCraftsCore\CPT;

use PintsAndCraftsCore\Lib;

/**
 * Class PostTypesLoader
 * @package PintsAndCraftsCore\CPT
 */
class PostTypesRegister {
	...
	private function addPostTypes() {
		$cpt_class_name = apply_filters( 'pintsandcrafts_core_filter_register_custom_post_types', $cpt_class_name = array() );
