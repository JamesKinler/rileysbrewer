...
$row_content_width = $anchor = $content_text_aligment = $simple_background_color = $simple_background_image = $background_size = $background_repeat = $disable_background_image = $parallax_background_image = $parallax_bg_speed = $parallax_bg_height = '';
...
if ( $row_content_width !== 'grid' ) {
    ...
    if ( ! empty( $background_size ) ) {
        $edgtf_vc_row_style[] = 'background-size: '. esc_attr( $background_size ) ;
    }

    if ( ! empty( $background_repeat ) ) {
        $edgtf_vc_row_style[] = 'background-repeat: '. esc_attr( $background_repeat ) ;
    }
    ...
    if ( ! empty( $background_size ) ) {
        $edgtf_grid_row_style[] = 'background-size: '. esc_attr( $background_size ) ;
    }

    if ( ! empty( $background_repeat ) ) {
        $edgtf_grid_row_style[] = 'background-repeat: '. esc_attr( $background_repeat ) ;
    }
...
if($row_content_width === 'grid'){
	$edgtf_row_wrapper_start .= '<div class="edgtf-row-grid-section-wrapper '.esc_attr($grid_row_classes).'" '.esc_attr($grid_row_datas).' ' . pintsandcrafts_edge_get_inline_style( $edgtf_grid_row_styles ) . '><div class="edgtf-row-grid-section">';
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . pintsandcrafts_edge_get_inline_style( $edgtf_vc_row_styles ) . '>';
