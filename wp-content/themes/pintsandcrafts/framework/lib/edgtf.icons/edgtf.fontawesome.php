...
class PintsAndCraftsPhpClassIconsFontAwesome implements iPintsAndCraftsPhpInterfaceIconCollection {
	...
	public function getDropdownCartIcon() {
		...
		return $this->render('fa-shopping-basket');
	}
	...
	public function getBackToTopIcon() {
		...
		return $this->render('fa-arrow-up');
	}
