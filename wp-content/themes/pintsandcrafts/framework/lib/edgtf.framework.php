...
/*
   Class: PintsAndCraftsPhpClassFramework
...
class PintsAndCraftsPhpClassFramework {
	...
	private function __construct() {
		$this->edgtOptions         = PintsAndCraftsPhpClassOptions::get_instance();
		$this->edgtMetaBoxes       = PintsAndCraftsPhpClassMetaBoxes::get_instance();
		$this->edgtTaxonomyOptions = PintsAndCraftsPhpClassTaxonomyOptions::get_instance();
		$this->edgtUserOptions     = PintsAndCraftsPhpClassUserOptions::get_instance();
		$this->edgtDashboardOptions = PintsAndCraftsPhpClassDashboardOptions::get_instance();
	}
	...
	public function setSkin( PintsAndCraftsPhpClassSkinAbstract $skinObject ) {
		$this->skin = $skinObject;
	}
}

/**
 * Class PintsAndCraftsPhpClassSkinManager
 *
...
class PintsAndCraftsPhpClassSkinManager {
	...
	/**
	 * @see PintsAndCraftsPhpClassSkinManager::setSkin()
	 */
	...
	private function setSkin( $skinName = EDGE_PROFILE_SLUG ) {
		if ( $skinName !== '' ) {
			if ( file_exists( get_template_directory() . '/framework/admin/skins/' . $skinName . '/skin.php' ) ) {
				...
				$skinName = ucfirst( $skinName ) . esc_html__( 'Skin', 'pintsandcrafts' );
...
/**
 * Class PintsAndCraftsPhpClassSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class PintsAndCraftsPhpClassSkinAbstract {
	/**
	 * @var string
	 */
	protected $skinName;
	...
	public function loadTemplatePart( $template, $params = array() ) {
		...
		if ( $template !== '' ) {
			include( pintsandcrafts_edge_find_template_path( 'framework/admin/skins/' . $this->skinName . '/templates/' . $template . '.php' ) );
		}
	}
	...
	public function setShortcodeJSParams() { ?>
		<script>
			window.edgtSCIcon = '<?php echo pintsandcrafts_edge_get_skin_uri() . '/assets/img/admin-logo-icon.png'; ?>';
			window.edgtSCLabel = '<?php echo esc_html( ucfirst( $this->skinName ) ); ?> <?php esc_html_e( 'Shortcodes', 'pintsandcrafts' ) ?>';
		</script>
	<?php }
...
/*
   Class: PintsAndCraftsPhpClassOptions
...
class PintsAndCraftsPhpClassOptions {
	...
	public function getOptionValue( $key ) {
		...
		if ( array_key_exists( $key, $pintsandcrafts_php_global_options ) ) {
			return $pintsandcrafts_php_global_options[ $key ];
...
/*
   Class: PintsAndCraftsPhpClassAdminPage
   A class that initializes Edge Admin Page
*/
class PintsAndCraftsPhpClassAdminPage implements iPintsAndCraftsPhpInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $slug;
	public $title;
	...
	function __construct( $slug = "", $title = "", $icon = "" ) {
		$this->layout  = array();
		$this->factory = new PintsAndCraftsPhpClassFieldFactory();
		$this->slug    = $slug;
		$this->title   = $title;
		$this->icon    = $icon;
	}
	...
	public function renderChild( iPintsAndCraftsPhpInterfaceRender $child ) {
		$child->render( $this->factory );
	}
}

/*
   Class: PintsAndCraftsPhpClassMetaBoxes
...
/*
   Class: PintsAndCraftsPhpClassMetaBox
   A class that initializes Edge Meta Box
*/
class PintsAndCraftsPhpClassMetaBox implements iPintsAndCraftsPhpInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	public $title;
	...
	public function setTitle( $label ) {
		...
		return $pintsandcrafts_php_global_Framework->getSkin()->getSkinLabel() . ' ' . $label;
	}
}

/*
   Class: PintsAndCraftsPhpClassTaxonomyOptions
   A class that initializes PintsAndCraftsPhpClass Taxonomy Options
*/
class PintsAndCraftsPhpClassTaxonomyOptions {
	private static $instance;
...
/*
   Class: PintsAndCraftsPhpClassTaxonomyOption
   A class that initializes PintsAndCraftsPhpClass Taxonomy Option
*/
class PintsAndCraftsPhpClassTaxonomyOption implements iPintsAndCraftsPhpInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new PintsAndCraftsPhpClassTaxonomyFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: PintsAndCraftsPhpClassUserOptions
   A class that initializes PintsAndCraftsPhpClass User Options
*/
class PintsAndCraftsPhpClassUserOptions {
	private static $instance;
	public $userOptions;
...
/*
   Class: PintsAndCraftsPhpClassUserOption
   A class that initializes PintsAndCraftsPhpClass User Option
*/
class PintsAndCraftsPhpClassUserOption implements iPintsAndCraftsPhpInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new PintsAndCraftsPhpClassUserFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: PintsAndCraftsPhpClassDashboardOptions
   A class that initializes PintsAndCraftsPhpClass Dashboard Options
*/
class PintsAndCraftsPhpClassDashboardOptions {
	private static $instance;
...
/*
   Class: PintsAndCraftsPhpClassDashboardOption
   A class that initializes PintsAndCraftsPhpClass Dashboard Option
*/
class PintsAndCraftsPhpClassDashboardOption implements iPintsAndCraftsPhpInterfaceLayoutNode {
	public $layout;
	private $factory;
	
	function __construct() {
		$this->layout        = array();
		$this->factory       = new PintsAndCraftsPhpClassDashboardFieldFactory();
	}
...
if ( ! function_exists( 'pintsandcrafts_edge_init_framework_variable' ) ) {
	function pintsandcrafts_edge_init_framework_variable() {
		global $pintsandcrafts_php_global_Framework;
		
		$pintsandcrafts_php_global_Framework = PintsAndCraftsPhpClassFramework::get_instance();
		$edgtSkinManager                 = new PintsAndCraftsPhpClassSkinManager();
		$pintsandcrafts_php_global_Framework->setSkin( $edgtSkinManager->getSkin() );
	}
	
	add_action( 'pintsandcrafts_edge_action_before_options_map', 'pintsandcrafts_edge_init_framework_variable' );
}
?>