...
/*
   Class: PintsAndCraftsPhpClassDashboardForm
   A class that initializes Edge Dashboard Container
*/
class PintsAndCraftsPhpClassDashboardForm implements iPintsAndCraftsPhpInterfaceLayoutNode, iPintsAndCraftsPhpInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: PintsAndCraftsPhpClassDashboardGroup
   A class that initializes PintsAndCraftsPhpClass Group Field
*/
class PintsAndCraftsPhpClassDashboardGroup implements iPintsAndCraftsPhpInterfaceLayoutNode, iPintsAndCraftsPhpInterfaceRender{
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: PintsAndCraftsPhpClassDashboardTitle
   A class that initializes Dashboard Title
*/
class PintsAndCraftsPhpClassDashboardTitle implements iPintsAndCraftsPhpInterfaceRender {
	private $name;
	private $title;
...
/*
   Class: PintsAndCraftsPhpClassDashboardField
   A class that initializes PintsAndCraftsPhpClass Front Field
*/

class PintsAndCraftsPhpClassDashboardField implements iPintsAndCraftsPhpInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class PintsAndCraftsPhpClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class PintsAndCraftsPhpClassDashboardFieldText extends PintsAndCraftsPhpClassDashboardFieldType {
...
class PintsAndCraftsPhpClassDashboardFieldTextArea extends PintsAndCraftsPhpClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class PintsAndCraftsPhpClassDashboardFieldImage extends PintsAndCraftsPhpClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
		...
		<div class="edgtf-dashboard-field-holder <?php echo esc_attr($class); ?>">
			...
			<div class="edgtf-dashboard-gallery-holder">
				...
				<div class="edgtf-dashboard-gallery-uploader">
					<?php 
					if ( pintsandcrafts_membership_theme_installed() ) {
						echo pintsandcrafts_edge_get_button_html( array(
							'text'      => esc_html__( 'Upload', 'pintsandcrafts' ),
							'custom_class' => 'edgtf-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" target="_self" class="edgtf-btn edgtf-btn-medium edgtf-btn-solid edgtf-dashboard-gallery-upload"><span class="edgtf-btn-text">' . esc_html__( 'Upload', 'pintsandcrafts' ) . '</span></a>';
					} ?>
					...
					<?php if ($value !== '' && $value !== false) { ?>
						<button class="edgtf-btn edgtf-btn-solid edgtf-dashboard-remove-image"><?php esc_html_e('Remove Media','pintsandcrafts'); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class PintsAndCraftsPhpClassDashboardFieldGallery extends PintsAndCraftsPhpClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class PintsAndCraftsPhpClassDashboardFieldSelect extends PintsAndCraftsPhpClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class PintsAndCraftsPhpClassDashboardFieldDate extends PintsAndCraftsPhpClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class PintsAndCraftsPhpClassDashboardFieldIcon extends PintsAndCraftsPhpClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = \PintsAndCraftsPhpClassIconCollections::get_instance()->getIconCollectionsEmpty();
		$icons_collections = \PintsAndCraftsPhpClassIconCollections::get_instance()->getIconCollectionsKeys();
				...
				<div class="edgtf-dashboard-item">
					...
					<div class="edgtf-dashboard-icon-holder">
						...
						<?php foreach ( $icons_collections as $icons_collection ) {
							$icons_param = \PintsAndCraftsPhpClassIconCollections::get_instance()->getIconCollectionParamNameByKey( $icons_collection );
	                        $style       = 'display: none';
							...
							<div class="edgtf-icon-collection-holder" style="<?php echo esc_attr( $style ); ?>" data-icon-collection="<?php echo esc_attr( $icons_collection ); ?>">
                                <select name="<?php echo esc_attr( $name . '[' . $icons_param . ']'); ?>" id="<?php echo esc_attr( $name . '[' . $icons_param . ']'); ?>">
									<?php
									$icons = \PintsAndCraftsPhpClassIconCollections::get_instance()->getIconCollection( $icons_collection );
...
class PintsAndCraftsPhpClassDashboardFieldColor extends PintsAndCraftsPhpClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class PintsAndCraftsPhpClassDashboardFieldCheckBoxGroup extends PintsAndCraftsPhpClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class PintsAndCraftsPhpClassDashboardFieldAddress extends PintsAndCraftsPhpClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
			...
			<div class="edgtf-dashboard-field-row">
				<div class="edgtf-dashboard-item col-lg-<?php echo esc_attr($col_width); ?>">
					<div class="edgtf-dashboard-input-holder">
						...
						<a id="reset" href="#" style="display:none;"><?php esc_html_e( 'Reset Marker', 'pintsandcrafts' ); ?></a>
					</div>
				</div>
			</div>
		</div>
...
class PintsAndCraftsPhpClassDashboardRepeater implements iPintsAndCraftsPhpInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
	...
	function __construct( $fields, $name, $label = '', $description = '', $button_text = '', $table_layout = false, $value = array() ) {
		...
		$this->name        = $name;
		$this->num_of_rows = 1;
		$this->button_text = ! empty( $button_text ) ? $button_text : esc_html__( 'Add New Item', 'pintsandcrafts' );
			...
			<?php if ($this->table_layout) { ?>
				<div class="edgtf-dashboard-repeater-table-heading">
					<div class="edgtf-dashboard-repeater-fields-holder">
						<div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'pintsandcrafts' ) ?></div>
						...
						<div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'pintsandcrafts' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class PintsAndCraftsPhpClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array()) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new PintsAndCraftsPhpClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'textarea':
				$field = new PintsAndCraftsPhpClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'date':
				$field = new PintsAndCraftsPhpClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new PintsAndCraftsPhpClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'gallery':
				$field = new PintsAndCraftsPhpClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new PintsAndCraftsPhpClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new PintsAndCraftsPhpClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new PintsAndCraftsPhpClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'checkboxgroup':
				$field = new PintsAndCraftsPhpClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'address':
				$field = new PintsAndCraftsPhpClassDashboardFieldAddress();
