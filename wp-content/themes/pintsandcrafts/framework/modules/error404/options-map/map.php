...
if ( ! function_exists( 'pintsandcrafts_edge_error_404_options_map' ) ) {
	function pintsandcrafts_edge_error_404_options_map() {
		
		pintsandcrafts_edge_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'pintsandcrafts' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);
		
		$panel_404_header = pintsandcrafts_edge_add_admin_panel(
			array(
		...
		pintsandcrafts_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a border bottom color for header area', 'pintsandcrafts' )
			)
		);
		...
		$panel_404_options = pintsandcrafts_edge_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'pintsandcrafts' )
			)
		);
		...
		pintsandcrafts_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'pintsandcrafts' )
			)
		);
		...
		pintsandcrafts_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'pintsandcrafts' )
			)
		);
		...
		pintsandcrafts_edge_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'pintsandcrafts' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'pintsandcrafts' )
			)
		);
		...
		pintsandcrafts_edge_add_admin_field(
			array(
				...
				'name'          => '404_title',
				'default_value' => '',
				'label'         => esc_html__( 'Title', 'pintsandcrafts' ),
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'pintsandcrafts' )
			)
		);
		...
		$first_level_group = pintsandcrafts_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'pintsandcrafts' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'pintsandcrafts' )
			)
		);
		...
		pintsandcrafts_edge_add_admin_field(
			array(
				...
				'name'          => '404_subtitle',
				'default_value' => '',
				'label'         => esc_html__( 'Subtitle', 'pintsandcrafts' ),
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'pintsandcrafts' )
			)
		);
		...
		$second_level_group = pintsandcrafts_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'pintsandcrafts' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'pintsandcrafts' )
			)
		);
		...
		pintsandcrafts_edge_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'pintsandcrafts' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'pintsandcrafts' )
			)
		);
		...
		$third_level_group = pintsandcrafts_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'pintsandcrafts' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'pintsandcrafts' )
			)
		);
		...
		pintsandcrafts_edge_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'pintsandcrafts' ),
				'description' => esc_html__( 'Enter label for "Back to home" button', 'pintsandcrafts' )
			)
		);
		...
		pintsandcrafts_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Skin', 'pintsandcrafts' ),
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'pintsandcrafts' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'pintsandcrafts' ),
					'light-style' => esc_html__( 'Light', 'pintsandcrafts' )
				)
			)
		);
	}
	
	add_action( 'pintsandcrafts_edge_action_options_map', 'pintsandcrafts_edge_error_404_options_map', 19 );
}