...
if ( ! function_exists( 'pintsandcrafts_edge_get_search' ) ) {
	...
	add_action( 'pintsandcrafts_edge_action_before_page_header_html_close', 'pintsandcrafts_edge_get_search' );
	add_action( 'pintsandcrafts_edge_action_before_mobile_header_html_close', 'pintsandcrafts_edge_get_search' );
}
...
if ( ! function_exists( 'pintsandcrafts_edge_load_search_template' ) ) {
	...
	function pintsandcrafts_edge_load_search_template() {
        ...
        pintsandcrafts_edge_get_module_template_part( 'types/slide-from-header-bottom/templates/slide-from-header-bottom', 'search', '', $parameters );
	}
}