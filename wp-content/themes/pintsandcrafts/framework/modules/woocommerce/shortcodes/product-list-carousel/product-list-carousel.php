...
namespace PintsAndCraftsCore\CPT\Shortcodes\ProductListCarousel;
...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Carousel', 'pintsandcrafts' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'pintsandcrafts' ),
							'value'       => array(
							...
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'pintsandcrafts' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'pintsandcrafts' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'pintsandcrafts' ),
							'value'       => array_flip( pintsandcrafts_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'pintsandcrafts' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'pintsandcrafts' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'pintsandcrafts' ),
							'group'       => esc_html__( 'Slider Settings', 'pintsandcrafts' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'slider_speed_animation',
							'heading'     => esc_html__( 'Slide Animation Duration', 'pintsandcrafts' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'pintsandcrafts' ),
							'group'       => esc_html__( 'Slider Settings', 'pintsandcrafts' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_navigation',
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'pintsandcrafts' ),
							'value'       => array_flip( pintsandcrafts_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'pintsandcrafts' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Navigation Skin', 'pintsandcrafts' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'pintsandcrafts' ),
							'value'       => array_flip( pintsandcrafts_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'pintsandcrafts' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Skin', 'pintsandcrafts' ),
							'value'      => array(
								esc_html__( 'Default', 'pintsandcrafts' ) => 'default',
								esc_html__( 'Light', 'pintsandcrafts' )   => 'light'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Position', 'pintsandcrafts' ),
							'value'      => array(
								esc_html__( 'Below Carousel', 'pintsandcrafts' )  => 'bellow-slider',
								esc_html__( 'Inside Carousel', 'pintsandcrafts' ) => 'inside-slider'
							),
							'dependency' => array( 'element' => 'slider_pagination', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Slider Settings', 'pintsandcrafts' )
						),
	...
	public function render( $atts, $content = null ) {
		...
		$html = pintsandcrafts_edge_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list-carousel', $params['type'], $params, $additional_params );
