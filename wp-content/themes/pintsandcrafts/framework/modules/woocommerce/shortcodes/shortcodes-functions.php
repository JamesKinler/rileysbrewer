...
if ( ! function_exists( 'pintsandcrafts_edge_include_woocommerce_shortcodes' ) ) {
	function pintsandcrafts_edge_include_woocommerce_shortcodes() {
	...
	if ( pintsandcrafts_edge_core_plugin_installed() ) {
		add_action( 'pintsandcrafts_core_action_include_shortcodes_file', 'pintsandcrafts_edge_include_woocommerce_shortcodes' );
	}
}

if ( ! function_exists( 'pintsandcrafts_edge_set_product_list_icon_class_name_for_vc_shortcodes' ) ) {
	/**
	...
	if ( pintsandcrafts_edge_core_plugin_installed() ) {
		add_filter( 'pintsandcrafts_core_filter_add_vc_shortcodes_custom_icon_class', 'pintsandcrafts_edge_set_product_list_icon_class_name_for_vc_shortcodes' );
	}
}