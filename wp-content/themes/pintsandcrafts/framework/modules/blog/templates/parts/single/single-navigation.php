<?php
$blog_single_navigation = pintsandcrafts_edge_options()->getOptionValue('blog_single_navigation') === 'no' ? false : true;
$blog_navigation_through_same_category = pintsandcrafts_edge_options()->getOptionValue('blog_navigation_through_same_category') === 'no' ? false : true;
?>
			...
			<?php
				...
				$post_navigation = array(
					'prev' => array(
						...
						'label' => '<span class="edgtf-blog-single-nav-label">'.esc_html__('previous', 'pintsandcrafts').'</span>'
					),
					'next' => array(
						'mark' => '<span class="edgtf-blog-single-nav-mark ion-ios-arrow-thin-right"></span>',
						'label' => '<span class="edgtf-blog-single-nav-label">'.esc_html__('next', 'pintsandcrafts').'</span>'
					)
				);
