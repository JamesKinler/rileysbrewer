...
$blog_list_image_id  = ! empty( $image_meta ) && pintsandcrafts_edge_blog_item_has_link() ? pintsandcrafts_edge_get_attachment_id_from_url( $image_meta ) : '';
?>

<?php if ( $has_featured ) { ?>
	<div class="edgtf-post-image">
		<?php if ( pintsandcrafts_edge_blog_item_has_link() ) { ?>
		...
		<?php } ?>
		<?php do_action('pintsandcrafts_edge_action_blog_inside_image_tag')?>
	</div>
<?php } ?>