...
if ( ! function_exists( 'pintsandcrafts_edge_get_blog_holder_classes' ) ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function pintsandcrafts_edge_get_blog_holder_classes( $classes ) {
	...
	add_filter( 'pintsandcrafts_edge_filter_blog_holder_classes', 'pintsandcrafts_edge_get_blog_holder_classes' );
}
