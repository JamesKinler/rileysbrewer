<?php
namespace PintsAndCraftsCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'pintsandcrafts' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'pintsandcrafts' )            => 'slider',
							esc_html__( 'Carousel', 'pintsandcrafts' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'pintsandcrafts' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		pintsandcrafts_edge_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
