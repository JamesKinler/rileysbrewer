<?php
namespace PintsAndCraftsCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'pintsandcrafts' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Simple', 'pintsandcrafts' )   => 'simple',
							esc_html__( 'Minimal', 'pintsandcrafts' )  => 'minimal'
						),
						'save_always' => true
					),
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'pintsandcrafts' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						'type'        => 'autocomplete',
						'param_name'  => 'category',
						'heading'     => esc_html__( 'Category', 'pintsandcrafts' ),
						'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'pintsandcrafts' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'image_size',
						'heading'    => esc_html__( 'Image Size', 'pintsandcrafts' ),
						'value'      => array(
							esc_html__( 'Original', 'pintsandcrafts' )  => 'full',
							esc_html__( 'Square', 'pintsandcrafts' )    => 'pintsandcrafts_edge_square',
							esc_html__( 'Landscape', 'pintsandcrafts' ) => 'pintsandcrafts_edge_landscape',
							esc_html__( 'Portrait', 'pintsandcrafts' )  => 'pintsandcrafts_edge_portrait',
							esc_html__( 'Thumbnail', 'pintsandcrafts' ) => 'thumbnail',
					...
					array(
						...
						'group'      => esc_html__( 'Post Info', 'pintsandcrafts' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'pintsandcrafts' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'pintsandcrafts' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'pintsandcrafts' ),
						'value'      => array_flip( pintsandcrafts_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'pintsandcrafts' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'pintsandcrafts' ),
						'value'      => array_flip( pintsandcrafts_edge_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Date', 'pintsandcrafts' ),
						'value'      => array_flip( pintsandcrafts_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'pintsandcrafts' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'pintsandcrafts' ),
						'value'      => array_flip( pintsandcrafts_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'pintsandcrafts' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'pintsandcrafts' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'pintsandcrafts' ),
						'value'      => array(
							esc_html__( 'None', 'pintsandcrafts' )            => 'no-pagination',
							esc_html__( 'Standard', 'pintsandcrafts' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'pintsandcrafts' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'pintsandcrafts' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'pintsandcrafts' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		pintsandcrafts_edge_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	public function blogCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['category_title'] ) > 0 ) ? esc_html__( 'Category', 'pintsandcrafts' ) . ': ' . $value['category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $category ) ) {
				...
				if ( ! empty( $category_title ) ) {
					$category_title_display = esc_html__( 'Category', 'pintsandcrafts' ) . ': ' . $category_title;
				}
