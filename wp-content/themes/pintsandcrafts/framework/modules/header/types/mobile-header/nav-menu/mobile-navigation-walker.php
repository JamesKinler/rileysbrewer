...
if (!class_exists('PintsAndCraftsPhpClassMobileNavigationWalker')) {
	class PintsAndCraftsPhpClassMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="edgtf-sub-arrow fa fa-chevron-right"></i><i class="fa fa-chevron-down"></i></span>';
				}
			}
