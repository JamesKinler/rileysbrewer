...
namespace PintsAndCraftsNamespace\Modules\Header\Lib;
/**
 * Class PintsAndCraftsPhpClassHeaderConnector
 *
...
class PintsAndCraftsPhpClassHeaderConnector {
	...
	public function connect( $config = array() ) {
		do_action( 'pintsandcrafts_edge_action_pre_header_connect' );
		...
		if ( ! empty( $config['affect_content'] ) ) {
			add_filter( 'pintsandcrafts_edge_filter_content_elem_style_attr', array( $this, 'contentMarginFilter' ) );
		}
		
		if ( ! empty( $config['affect_title'] ) ) {
			add_filter( 'pintsandcrafts_edge_filter_title_content_padding', array( $this, 'titlePaddingFilter' ) );
		}
		
		do_action( 'pintsandcrafts_edge_action_after_header_connect' );
	}
	 ...
	 *
	 * Hooks to pintsandcrafts_edge_filter_title_content_padding filter
	 *
	 * @return int
	 */
