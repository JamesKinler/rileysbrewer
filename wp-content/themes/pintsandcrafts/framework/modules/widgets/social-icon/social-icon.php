...
class PintsAndCraftsPhpClassSocialIconWidget extends PintsAndCraftsPhpClassWidget {
	
	public function __construct() {
		parent::__construct(
			'edgtf_social_icon_widget',
			esc_html__( 'Edge Social Icon Widget', 'pintsandcrafts' ),
			array( 'description' => esc_html__( 'Add social network icons to widget areas', 'pintsandcrafts' ) )
		);
	...
	protected function setParams() {
		$this->params = array_merge(
			pintsandcrafts_edge_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'  => 'textfield',
					'name'  => 'link',
	...
	public function widget( $args, $instance ) {
		...
		<a class="edgtf-social-icon-widget-holder edgtf-icon-has-hover" <?php echo pintsandcrafts_edge_get_inline_attr( $hover_color, 'data-hover-color' ); ?> <?php pintsandcrafts_edge_inline_style( $icon_styles ) ?> href="<?php echo esc_url( $link ); ?>" target="<?php echo esc_attr( $target ); ?>">
